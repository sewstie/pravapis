...
</style><main><div class="accent"></div><div class="wordmark"><span class="symbol">⇄</span>pravapis</div><div class="label">Беларускі правапіс — ваш выбар</div><div class="example">Снег <span class="arrow">→</span><span style="color:#a1271f">Сьнег</span></div><div class="bottom"><span>наркамаўка &nbsp;↔&nbsp; тарашкевіца</span><span>pravapis.vercel.app</span></div></main></html>`);
